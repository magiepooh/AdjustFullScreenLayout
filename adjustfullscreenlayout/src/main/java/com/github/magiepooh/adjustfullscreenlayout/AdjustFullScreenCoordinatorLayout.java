 ...
 */
public class AdjustFullScreenCoordinatorLayout extends CoordinatorLayout {

  private ScreenState screenState = ScreenState.NORMAL;
  private DisplayCalculator calculator;

  public AdjustFullScreenCoordinatorLayout(Context context) {
    this(context, null);
  }

  public AdjustFullScreenCoordinatorLayout(Context context, AttributeSet attrs) {
